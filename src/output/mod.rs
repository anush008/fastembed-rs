...
//!
//! Typically, [`ort::session::Session::run`] will generate a
//! [`ort::session::SessionOutputs`] object. This object contains all the keys and
//! values of the outputs generated by the model, which could all be useful to the caller.
//!
//! This module wraps the [`ort::session::SessionOutputs`] objects created from batching,
...
//!   as pooling.
//! - [`EmbeddingOutput`]: This struct wraps the [`ort::session::SessionOutputs`] objects, acting as a
